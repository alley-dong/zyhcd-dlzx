 ...
 * @date 2020-12-09
 */
public class PContractEvaluatExcel extends BaseEntity
{
    ...
    /** 供应商 评价列表 */
    private List<PContractEvaluateMetricsExcel> pContractEvaluateMetricsList;
    ...
    public List<PContractEvaluateMetricsExcel> getpContractEvaluateMetricsList() {
        return pContractEvaluateMetricsList;
    }

    public void setpContractEvaluateMetricsList(List<PContractEvaluateMetricsExcel> pContractEvaluateMetricsList) {
