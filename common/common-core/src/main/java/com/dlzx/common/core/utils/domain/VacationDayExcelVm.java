 ...
 */
public class VacationDayExcelVm {
    ...
    /** 存放状态 */
    private List<EveryDayDetailExcelVm> dVacationDayList;
    ...
    public List<EveryDayDetailExcelVm> getdVacationDayList() {
        return dVacationDayList;
    }

    public void setdVacationDayList(List<EveryDayDetailExcelVm> dVacationDayList) {
