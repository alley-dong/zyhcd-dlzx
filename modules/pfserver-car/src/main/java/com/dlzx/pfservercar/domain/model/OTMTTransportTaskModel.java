...
public class OTMTTransportTaskModel {
    ...
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    private Date EXTEND_TEXT4;
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    private Date EXTEND_TEXT5;
    ...
    public Date getEXTEND_TEXT4() {
        return EXTEND_TEXT4;
    }

    public void setEXTEND_TEXT4(Date EXTEND_TEXT4) {
        this.EXTEND_TEXT4 = EXTEND_TEXT4;
    }

    @JsonProperty("EXTEND_TEXT5")
    public Date getEXTEND_TEXT5() {
        return EXTEND_TEXT5;
    }

    public void setEXTEND_TEXT5(Date EXTEND_TEXT5) {
     ...
     */
    public TTransportTaskOvertimeModel convert() {
        return new Function<OTMTTransportTaskModel, TTransportTaskOvertimeModel>() {
            @Override
            public TTransportTaskOvertimeModel apply(OTMTTransportTaskModel otmtTransportTaskModel) {
                //属性拷贝
                TTransportTaskOvertimeModel tTransportTaskOvertimeModel = new TTransportTaskOvertimeModel();
                tTransportTaskOvertimeModel.setId(UUID.randomUUID()+"");
                tTransportTaskOvertimeModel.setShipmentXid(otmtTransportTaskModel.getSHIPMENT_XID());
                tTransportTaskOvertimeModel.setArteryShipmentXid(otmtTransportTaskModel.getEXTEND_TEXT1());
                tTransportTaskOvertimeModel.setMainVehicleId(otmtTransportTaskModel.getMainVehicleId());
                tTransportTaskOvertimeModel.setMainLicensePlate(otmtTransportTaskModel.getEQUIPMENT_NUMBER());
                tTransportTaskOvertimeModel.setHangVehicleId(otmtTransportTaskModel.getHangVehicleId());
                tTransportTaskOvertimeModel.setHangLicensePlate(otmtTransportTaskModel.getASSISTANT_DRIVER_NUMBER());
                tTransportTaskOvertimeModel.setDriverId(otmtTransportTaskModel.getDriverId());
                tTransportTaskOvertimeModel.setDriverName(otmtTransportTaskModel.getDRIVER_NAME());
                tTransportTaskOvertimeModel.setOilAmount(new BigDecimal(otmtTransportTaskModel.getEXTEND_TEXT3()==null?"0":otmtTransportTaskModel.getEXTEND_TEXT3()));
                tTransportTaskOvertimeModel.setOvertimeAmount(new BigDecimal(otmtTransportTaskModel.getEXTEND_TEXT2()==null?"0":otmtTransportTaskModel.getEXTEND_TEXT2()));
                tTransportTaskOvertimeModel.setOrigin(otmtTransportTaskModel.getSOURCE_PROVINCE()+"-"+otmtTransportTaskModel.getSOURCE_CITY()+"-"+otmtTransportTaskModel.getSOURCE_DISTRICT()+"-"+otmtTransportTaskModel.getSOURCE_ADDRESS()+"-"+otmtTransportTaskModel.getSOURCE_LOCATION_NAME());
                tTransportTaskOvertimeModel.setDestination(otmtTransportTaskModel.getDEST_PROVINCE()+"-"+otmtTransportTaskModel.getDEST_CITY()+"-"+otmtTransportTaskModel.getDEST_DISTRICT()+"-"+otmtTransportTaskModel.getDEST_ADDRESS()+"-"+otmtTransportTaskModel.getDEST_LOCATION_NAME());
                tTransportTaskOvertimeModel.setCreateTime(new Date());
                tTransportTaskOvertimeModel.setTaskStartTime(otmtTransportTaskModel.getEXTEND_TEXT4());
                tTransportTaskOvertimeModel.setTaskEndTime(otmtTransportTaskModel.getEXTEND_TEXT5());
                return tTransportTaskOvertimeModel;
            }
        }.apply(this);
    }
