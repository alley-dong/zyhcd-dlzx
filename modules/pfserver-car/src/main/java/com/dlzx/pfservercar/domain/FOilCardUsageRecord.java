...
public class FOilCardUsageRecord extends BaseEntity {
    ...
    private Date adminShowTransactionTime;

    public Date getAdminShowTransactionTime() {
        return adminShowTransactionTime;
    }

    public void setAdminShowTransactionTime(Date adminShowTransactionTime) {
        this.adminShowTransactionTime = adminShowTransactionTime;
    }
