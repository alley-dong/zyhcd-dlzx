 ...
 * @date 2020-12-10
 */
public class SafeTrafficTransgressionAp extends BaseEntity {
    ...
    @Excel(name = "违章地址", width = 30, dateFormat = "yyyy-MM-dd")
    private String wzdd;
    ...
    // 处理凭证
    private List<SysFile> voucherFileList;
    /**
     * 完成时间
     */
    @JsonFormat(pattern = "yyyy-MM-dd")
    ...
    public List<SysFile> getVoucherFileList() {
        return voucherFileList;
    }

    public void setVoucherFileList(List<SysFile> voucherFileList) {
