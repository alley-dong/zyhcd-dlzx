 ...
 * @date 2020-12-08
 */
public class DSubsidy extends BaseEntity {
...
//    结束时间
    ...
    // 补助日期
    private List<DSubsidy> dSubsidyList;

    public List<DSubsidy> getdSubsidyList() {
        return dSubsidyList;
    }

    public void setdSubsidyList(List<DSubsidy> dSubsidyList) {
        this.dSubsidyList = dSubsidyList;
    }
    ...
    public DSubsidy(String driverId, Long type) {
        this.driverId = driverId;
        this.type = type;
    }
