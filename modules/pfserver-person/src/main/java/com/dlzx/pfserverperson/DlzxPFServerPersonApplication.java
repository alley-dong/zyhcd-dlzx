package com.dlzx.pfserverperson;
...
public class DlzxPFServerPersonApplication extends WebMvcConfigurerAdapter
{
    public static void main(String[] args)
    {
        SpringApplication.run(DlzxPFServerPersonApplication.class, args);
        System.out.println("(♥◠‿◠)ﾉﾞ  人模块启动成功   ლ(´ڡ`ლ)ﾞ");
    }
