...
public class GGoodsCheckItem extends BaseEntity
{
    ...
    private List<GGoods> gGoodsList;

    private List<GGoodsCheckItem> gGoodsCheckItemList;

    public List<GGoodsCheckItem> getgGoodsCheckItemList() {
        return gGoodsCheckItemList;
    }

    public void setgGoodsCheckItemList(List<GGoodsCheckItem> gGoodsCheckItemList) {
        this.gGoodsCheckItemList = gGoodsCheckItemList;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("gGoodsCheckItemList", getgGoodsCheckItemList())
            .append("checkIds", getCheckIds())
            .append("gGoodsList", getgGoodsList())
            .toString();
    }
    ...
    public List<GGoods> getgGoodsList() {
        return gGoodsList;
    }

    public void setgGoodsList(List<GGoods> gGoodsList) {
        this.gGoodsList = gGoodsList;
    }
}
