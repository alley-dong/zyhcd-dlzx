 ...
 * @date 2020-12-02
 */
public interface GGoodsInventoryMapper 
{
    /**
     * 查询库存管理-库存
     * 
    ...
    public int countAll(@Param("goodsName") String goodsName);

    public int countAllEdit(@Param("goodsId") String goodsId, @Param("goodsName") String goodsName);
