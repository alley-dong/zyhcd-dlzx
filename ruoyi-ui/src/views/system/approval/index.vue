  ...
  <div class="app-container">
    <el-form :inline="true" class="demo-form-inline" :model="listQuery">
      ...
      <el-form-item label="审批任务：">
        <el-select v-model="listQuery.type" clearable placeholder="审批任务">
          <el-option
    ...
    >
      <!-- <el-table-column
        ...
        width="80px"
      ></el-table-column> -->
      <el-table-column label="审批业务" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.typeEnum }}</span>
        </template>
      </el-table-column>
      <!-- TODO: -->
...
<script>
import { configB05list, delUser,dataDictCodeForSp  } from "@/api/system/approval";
// import {
//   listRole,
//   getRole,
//   delRole,
...
export default {
  ...
  created() {
    this.getList();
    dataDictCodeForSp().then((response) => {
  ...
  methods: {
    ...
    handleUpdate(row) {
      console.log("查看");
      this.$router.push({path:'/detailApproval/'+row.id,query:{type:row.typeEnum,mytype:row.level,type1:row.type}})
    },
