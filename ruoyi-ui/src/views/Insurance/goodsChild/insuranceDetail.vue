      ...
      <el-form ref="elForm" :model="formData" size="medium" label-width="100px">
        ...
        <el-col :span="24">
          <el-form-item label="车牌号">
            <div>
              <el-tag v-for="item in formData.cInsuranceVehicleGoogds" :key="item.id">{{item.licensePlate}}</el-tag>
              <!-- {{ formData.licensePlateName }} -->
            </div>
          </el-form-item>
        </el-col>
        <!-- <el-col :span="12">
...
<script>
import { googdsE11Info } from "@/api/system/vehicle";
