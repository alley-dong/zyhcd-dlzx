    ...
    <div>
        <div style="width:98%; margin:0 auto; margin:20px 10px 0 0; overflow:hidden;">
            ...
            <router-link :to="{path:'/addNotice',name: 'addNotice'}"> 
                <el-button type="primary" style="float: right;margin-right: 10px;">返回</el-button>
            </router-link>
        </div>
        ...
        <el-table ref="multipleTable" border :data="tableData" tooltip-effect="dark" style="width: 90%; margin:0 auto; margin-top:20px; margin-bottom:30px;" @selection-change="handleSelectionChange">
...
export default {
    ...
    methods: {
        ...
        submitClick() {
            ...
            this.$router.push({path:'/addNotice',query: {id: this.listQuery.id }})
        }
    }
}
</script>
