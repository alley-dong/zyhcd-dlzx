  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item style="float:right">
        <buttonGroup
          :addHasPermi="['pfserverperson:contract:carriersadd']"
      ...
      >
        <template slot-scope="scope">
          <el-button
            ...
            size="small"
            plain
            v-hasPermi="['pfserverperson:contract:carriersedit']"
            >修改</el-button
          >
          <el-button
            class="button"
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      CarriersContractList(this.queryParams).then((response) => {
