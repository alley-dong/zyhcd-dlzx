    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['car:Insurance:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['car:Insurance:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listInsurance, getInsurance, delInsurance, addInsurance, updateInsurance } from "@/api/car/Insurance";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除车辆管理-险种类别编号为"' + ids + '"的数据项?', "警告", {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('car/Insurance/export', {
        ...this.queryParams
      }, `car_Insurance.xlsx`)
    }
  }
