<template>
  <div class="app-container">
        ...
        >
          ...
          <!-- <el-col :span="24">
            <el-form-item label="维修保养项">
              <div style="text-align: left">{{ formData.itemName }}</div>
            </el-form-item>
          </el-col>
          <el-col :span="24">
    ...
    >
      ...
      &lt;!&ndash;TODO:  统计&ndash;&gt;
      &lt;!&ndash; <el-table-column label="统计" align="center">
        <template slot-scope="scope">
          <span
            >本月第{{ scope.row.monthNumber }}次，本年第{{
              scope.row.yearNumber
    ...
    <div class="box" style="margin-left: 55px">
      <el-row :gutter="15">
        <el-col :span="24" style="margin-bottom: 20px">
          <el-radio-group v-model="formData1.status" style="text-align: left">
            <el-radio
...
export default {
  ...
  methods: {
    ...
    editClick() {
      console.log("编辑");
      H07StationCheck(this.formData1).then((res) => {
        this.backClick();
      });
    },
  },
