      ...
      >
        ...
        <el-col :span="12">
          <el-form-item label="车牌号" prop="licensePlate">
            <!-- <el-input v-model="formData.licensePlate" placeholder="请输入任务编号" clearable :style="{width: '100%'}"> -->
            <!-- </el-input> -->
        ...
        <el-col :span="24" style="margin-bottom: 20px">
          <div style="display: flex">
            <div>
              ...
              <el-radio v-model="formData1.status" label="2">不通过</el-radio>
            </div>
          </div>
        </el-col>
        <el-col :span="24" style="margin-bottom: 20px">
          <el-input
            v-model="formData1.reviewRemark"
            type="textarea"
            placeholder="请输入"
...
export default {
  ...
  methods: {
    ...
    // 提交
    editClick() {
      this.formData1.vehicleId = this.$route.query.vehicleId;
      this.formData1.reviewRemarks = this.formData1.reviewRemark
